...
foreach ($_SESSION['cart'] as $item_cart) {
    $cartTotal += $item_cart['quantity'] * $item_cart['price'];
}
?>
<!DOCTYPE html>
<html lang="auto">
...
<head>
    <title>COZA STORE - SPECIALIZED IN HIGH LEVEL FASHION</title>
    <meta charset="UTF-8">
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="public/assets/fonts/linearicons-v1.0.0/icon-font.min.css">
    <!--===============================================================================================-->
    ...
    <header class="header-v4">
                ...
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        if (isset($_SESSION['role'])) : ?>
                            <a href="/profile" class="flex-c-m trans-04 p-lr-25"> <?= $_SESSION['firstname'] . ' ' . $_SESSION['lastname'] ?></a>
                        <?php else : ?>
                            <a href="/login" class="flex-c-m trans-04 p-lr-25">My Account</a>
                        <?php endif; ?>

                        <a href="#" class="flex-c-m trans-04 p-lr-25" id="vie">
                            EN
                        </a>
        ...
        <div class="menu-mobile">
            ...
            <ul class="main-menu-m">
                ...
                <li>
                    <a class="label1 rs1" data-label1="hot" href="/shop">Shop</a>
                </li>
        ...
        <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
            <div class="container-search-header">
                ...
                <form class="wrap-search-header flex-w p-l-15" method="get" action="#">
                    ...
                    <input class="plh3" type="text" name="search_text" id="search_text" placeholder="Search...">
                </form>
            </div>
        </div>
    </header>
        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25">
            ...
            <div class="header-cart-content flex-w js-pscroll">
                <ul class="header-cart-wrapitem w-full">
                            ...
                            <li class="header-cart-item flex-w flex-t m-b-12">
                                ...
                                <div class="header-cart-item-txt p-t-8">
                                    ...
                                    <div class="flex-w flex-sb">
                                        ...
                                        <span class="header-cart-item-info">
                                            <a href="/remove-cart?delete=<?= $item_cart['id'] ?>" class="text-danger"><i class="fs-20 zmdi zmdi-delete"></i></a>
                                        </span>
                                    </div>
                                </div>
                            </li>
                    ...
                    <?php else : ?>
                        <li class="header-cart-item flex-w flex-t m-b-12">
                            <div class="header-cart-item-txt p-t-200 text-center">
