<?php
$html_get_one_item = new App\model\Product();
$one_item = $html_get_one_item->get_one_product($_GET['id']);
$get_product = $html_get_one_item->get_product(8);
?>
<!-- breadcrumb -->
<div class="container">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        <?php foreach ($one_item as $pro_one) : ?>
            <a href="/shop" class="stext-109 cl8 hov-cl1 trans-04">
                <?= $pro_one['category_name'] ?>
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="public/assets/images/product/<?= $pro_one['img'] ?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="public/assets/images/product/<?= $pro_one['img'] ?>" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="public/assets/images/product/<?= $pro_one['img'] ?>">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            ...
                            <form class="flex-w flex-r-m p-b-10" action="add-cart" method="post">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                        ...
                                        <input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" s value="1">
                                    ...
                                    <button type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" name="btn-add-cart">
                                        <!-- <a href="/shoping-cart?id=#" > -->
                                        Add to cart
                                        <!-- </a> -->
                                    </button>
                                </div>
